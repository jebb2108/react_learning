...
export function Header() {
    return (
        ...
        <button className='text-white w-44 bg-teal-600 hover:bg-teal-500 transition-colors rounded-lg px-5 py-2'>Играть</button>
        <button className='ml-auto flex items-center gap-2 text-start  hover:text-teal-500'>
            <Image src={profileImg} height={48} width={48} alt='profile' unoptimized/>
            <div>
